...
// Usage:
//
//    instrumentmain package [package]...
//
...
func main() {
	...
	os.Exit(generateMainFromTemplate(&cov))
}

func generateMainFromTemplate(cover *Cover) int {
	tmpl, err := template.New("Main").Parse(testmainTmplStr)
	if err != nil {
		fmt.Fprintln(os.Stderr, "Failed to parse the main.go template. Error: %s\n", err.Error())
		return 1
	}
	if err := tmpl.Execute(os.Stdout, cover); err != nil {
...
////////////////////////////////////////////////////////////
// Code from github.com/mendersoftware/mender/main.go 
////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
// end code from github.com/mendersoftware/mender/main.go
////////////////////////////////////////////////////////////
`
